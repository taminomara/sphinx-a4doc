...
from sphinx_a4doc.autodoc_directive import A4Autogrammar
...
def setup(app: sphinx.application.Sphinx):
    ...
    app.add_directive_to_domain('a4', 'autogrammar', A4Autogrammar)

    app.add_config_value('a4_base_path', '.', True, str)
